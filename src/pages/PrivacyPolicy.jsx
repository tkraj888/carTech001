...
function PrivacyPolicy() {
  ...
  return (
    <div className="max-w-screen-3xl mx-auto  ">
      <div className="flex justify-center items-center bg-light-blue-200 h-24 md:h-28 lg:h-30">
        <div>
          <p className="text-4xl md:text-5xl lg:text-6xl m-6 lg:m-32 text-[#1E2761]">
            Privacy Policy
          </p>
        </div>
      </div>
      <div className="mx-4 mt-16 md:ml-20 md:mr-12 lg:ml-36 lg:mr-24">
        <p className="text-3xl font-bold">Our Commitment to You</p>
        <p className="mt-6 text-lg">
          At CarTechIndia, your privacy is a top priority. Your privacy is at
          the core of the way we design and build the services and products you
          know and love, so that you can fully trust them and focus on building
        ...
        <p className="mt-4 text-lg">
          We do not compromise with your privacy. We design all of our products
          and services with your privacy in mind. We involve experts from
        ...
        <p className="mt-4 text-lg">
          We strive to be transparent in the way we process your data. Because
          we use many of the same online services you do, we know that
          ...
          language. We actually want you to read our policies and understand our
          privacy practices!
        </p>
        <p className="mt-4 text-lg">
          We work hard to keep your information secure. We have teams dedicated
          to keeping your data safe and secure. We constantly update our
        ...
        <p className="mt-6 text-xl">
          Welcome to CarTechIndia’s Privacy Policy. Thank you for taking the
          time to read it.
        </p>
        <p className="mt-4 text-lg">
        ...
        <p className="mt-6 text-lg">
          ...
          services operated by CarTechIndia. For simplicity, we refer to all of
        ...
        <p className="mt-6 text-lg">
          We collect basic profile details and the training you use our
          services, for example access logs, as well as information from third
          parties, like when you access our services through a social media
        ...
        <p className="mt-4 ml-8 text-lg">
          ...
          insights into our products and services, responses to our questions
          and testimonials. <br />
          When you choose to participate in our promotions, events or contests,
          we collect the information that you use to register or enter. <br />
          ...
          interactions for training purposes and to ensure a high quality of
          service. <br />
          If you ask us to communicate with or otherwise process information of
          other people (for example, if you ask us to send an email on your
          behalf to one of your friends), we collect the information about
          others that you give us in order to complete your request. <br />
        ...
        <p className="mt-4 ml-8 text-lg">
          <b>Other Users </b> Other users may provide information about you as
          they use our services. For instance, we may collect information about
          you from other users if they contact us about you. <br />
          <b>Social Media</b> You may be able to use your social media login
          (such as Facebook Login) to create and log into your CarTechIndia
          account. This saves you from having to remember yet another user name
          and password and allows you to share some information from your social
          media account with us. <br />
          <b>Other Partners</b> We may receive info about you from other social
          networking platforms or from our partners, for instance where
          CarTechIndia ads are published on a partner’s websites and platforms
        ...
        <p className="mt-4 text-lg">
          ...
          our services. See below for more details:
        </p>
        <p className="mt-4 text-lg">
          <b>Usage Information</b> We collect information about your activity on
          our services, for instance how you use them (e.g., date and time you
          logged in, features you’ve been using, searches, clicks and pages
          which have been shown to you, referring web page address, advertising
        ...
        <p className="mt-4 text-lg">
          <b>Device information</b> We collect information from and about the
        ...
        <p className="mt-4 ml-8 text-lg">
          ...
          crashes, advertising IDs (such as Google’s AAID and Apples IDFA, both
          of which are randomly generated numbers that you can reset by going
          into your device’ settings), browser type, version and language,
          ...
          (e.g., IMEI/UDID and MAC address); <br />
          information on your wireless and mobile network connection, like your
          service provider and signal strength; <br />
        ...
        <p className="mt-6 text-lg">
          ...
          (e.g., web beacons, pixels) to recognize you and/or your device(s). We
          use cookie related information (such as authenticating you,
        ...
        <p className="mt-4 text-lg">
          ...
          including CarTechIndia, do not currently respond to DNT signals.
        </p>
        ...
        <p className="mt-6 text-lg">
          ...
          provide you with advertising that may be of interest to you. Read on
          for a more detailed explanation of the various reasons we use your
          information, together with practical examples.
        </p>
        <p className="mt-4 text-xl">
          <b>To improve our services and develop new ones, we</b>
        </p>
        <p className="mt-4 ml-8 text-lg">
          Administer focus groups and surveys <br />
        ...
        <p className="mt-4 ml-8 text-lg">
          ...
          for administrative, fraud detection and other legal purposes. <br />
        ...
        <p className="mt-6 text-lg">
          ...
          sharing of users’ information is, of course, with other users. We also
          share some users’ information with service providers and partners who
          assist us in operating the services, with other Match Group companies
          and, in some cases, legal authorities. Read on for more details about
          how your information is shared with others.
        </p>
        ...
        <p className="mt-4 text-lg">
          <u>Updating your information.</u> If you believe that the information
          we hold about you is inaccurate or that we are no longer entitled to
          use it and want to request its rectification, deletion or object to
          its processing, please contact us at <u>asif.attar@caryanam.in</u>{" "}
          <br />
        ...
        <p className="mt-4 ml-8 text-lg">
          <u>Uninstall.</u> You can stop all information collection by an app by
          uninstalling it using the standard uninstall process for your device.
          If you uninstall the app from your mobile device, the unique
          identifier associated with your device will continue to be stored. If
          you reinstall the application on the same mobile device, we will be
          able to re-associate this identifier to your previous transactions and
          activities. <br />
          <u>Accountability.</u> In certain countries, including in the European
        ...
        <p className="mt-4 text-lg">
          ...
          immediately on <u>asif.attar@caryanam.in</u>
        </p>
        ...
        <p className="mt-4 text-lg">
          ...
          legitimate business and as permitted by applicable law. To protect the
          safety and security of our users on and off our services, we implement
          a safety retention window of three months following account deletion.
          During this period, account information will be retained although the
        ...
        <p className="mt-4 ml-8 text-lg">
          ...
          similar consents are kept for five years); <br />
          3. There is an outstanding issue, claim or dispute requiring us to
          keep the relevant information until it is resolved; or <br />
        ...
        <p className="mt-4 text-lg">
          ...
          promise that all data will be deleted within a specific time frame due
        ...
        <p className="mt-4 text-lg deccoration-none">
          Email : <i>asif.attar@caryanam.in</i>
        </p>
        <p className="mt-4 text-lg mb-20">By phone : 7755994123</p>

...
const VehicleById: React.FC = () => {
  ...
  const fetchVehicleById = async () => {
    ...
    try {
      const response = await axios.get(`https://carauto01-production-8b0b.up.railway.app/vehicle-reg/getById?vehicleRegId=${vehicleId}`);
  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center min-h-screen bg-gray-100 py-10">
        <h2 className="text-3xl font-bold text-blue-600 mb-6">Find  Vehicle ID</h2>
